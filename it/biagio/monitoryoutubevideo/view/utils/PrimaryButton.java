...
/**
 * Class for the primary buttons.
 * 
 * @author Giulio Biagini - giulio.biagini90@gmail.com
 */
@SuppressWarnings("serial")
public class PrimaryButton extends AButton
{
	/**
	 ...
	 */
	public PrimaryButton(Icon icon, String toolTipText) {
		super(
			icon,
			toolTipText,
			Const.PRIMARY_BUTTON_BACKGROUND_COLOR,
			Const.PRIMARY_BUTTON_BORDER_COLOR
		);
	}
}